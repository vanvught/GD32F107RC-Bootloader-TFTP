...
DEFINES="-DGD32 -DGD32F10X -DGD32F10X_CL -DGD32F107RC -DBOARD_GD32F107RC -DPHY_TYPE=DP83848 -DNDEBUG -D_TIME_STAMP_YEAR_=2025 -D_TIME_STAMP_MONTH_=12 -D_TIME_STAMP_DAY_=29 -DCONFIG_STORE_USE_ROM -DCONFIG_TIMER6_HAVE_NO_IRQ_HANDLER -DCONFIG_HAL_USE_SYSTICK -DCONFIG_NET_APPS_NO_MDNS -DDISABLE_JSON -DDISABLE_RTC -DDISABLE_FS -DDISABLE_PRINTF_FLOAT -DENABLE_TFTP_SERVER -DUDP_MAX_PORTS_ALLOWED=3 -DENET_RXBUF_NUM=2 -DENET_TXBUF_NUM=1 -DRTL8201F_LED1_LINK_ALL -DCONFIG_REMOTECONFIG_MINIMUM -DCONFIG_STORE_USE_ROM -DDEBUG_STACK -DNDEBUG -DCONFIG_STORE_USE_ROM -D_TIME_STAMP_YEAR_=2025 -D_TIME_STAMP_MONTH_=12 -D_TIME_STAMP_DAY_=29 -DCONFIG_TIMER6_HAVE_NO_IRQ_HANDLER -DCONFIG_HAL_USE_SYSTICK -DCONFIG_HAL_USE_SYSTICK -DCONFIG_NET_APPS_NO_MDNS"
